<div class="salPayFormBody" ng-controller="salPayController as ctrl">
	<form role="form">
		<div class="row lineHeight">
			 <div class="form-group">
			 	 <div class="col-sm-2 text-right"><label class="control-label" for="custList">Customer Name:</label></div>
   				 <div class="col-sm-3 text-left">
   				 	<ui-select id="custList" ng-model="ctrl.custData" theme="selectize" on-select="ctrl.fetchBillDetails(ctrl.custData.custId)">
		...
		<div class="row lineHeight">
   	  	...
   	  	<div class="row lineHeight">
			 <div class="form-group">
			 	 <div class="col-sm-2 text-right"><label class="control-label" for="bank">Party Bank Name:</label></div>
   				 <div class="col-sm-3 text-left">
			 ...
			 <div class="form-group">
			 	 <div class="col-sm-2 text-right"><label class="control-label" for="bank">Self Bank Name:</label></div>
   				 <div class="col-sm-3 text-left">
   				 	<ui-select id="bank" ng-disabled="ctrl.user.actType" ng-model="ctrl.selfBankData" theme="selectize" on-select="">
					    <ui-select-match placeholder="Select Bank">{{$select.selected.bankName}}</ui-select-match>
