<div class="salesFormBody" ng-controller="salesController as ctrl">
	<form role="form">
		<div class="row lineHeight">
			 <div class="form-group">
   				 <div class="col-sm-2 text-right"><label class="control-label" for="billNo">Bill No:</label></div>
   				 <div class="col-sm-3 text-left"><input class="form-control" ng-model="ctrl.user.billNo" id="billNo" disabled="disabled"/></div>
			 </div>
   	  	</div>
		<div class="row lineHeight">
			 <div class="form-group">
		...
		<div class="row lineHeight">
			 <div class="form-group">
   				 ...
   				 <div class="col-sm-3 text-left">
	   				 <ui-select id="customer" ng-model="ctrl.custData" theme="selectize">
			 ...
			 <div class="col-sm-2 text-right"><button id="addProduct" type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#prodModal" ng-if="gridOptions2.data.length < 15">Add Product</button></div>
           	 <div class="col-sm-2 text-center"><button id="updateproduct" ng-click="ctrl.updateSalesProd()" class="btn btn-default btn-sm" data-toggle="modal" data-target="#prodUpdateModal">Modify Product</button></div>
   			 <div class="col-sm-2"><button id="deleteProduct" ng-click="ctrl.deleteSalesProd()" class="btn btn-default btn-sm">Delete Product</button></div>
		</div>
			        ...
			        <div class="modal-body">
			        	<div class="row lineHeight">
							 ...
							 <div class="form-group">
				   				 ...
				   				 <div class="col-sm-3 text-left">
				   				 	<ui-select id="dlgMRP" ng-model="ctrl.productData" theme="selectize" on-select="ctrl.fetchProdDetails(ctrl.productData.mrp)">
							 ...
							 <div class="form-group">
				   				 ...
				   				 <div class="col-sm-3 text-left"><input class="form-control" ng-model="ctrl.productData.qty" id="dlgQty" ng-blur="ctrl.validateStock();ctrl.calculateQtyRate()"/></div>
							 ...
							 <div class="form-group">
				   				 ...
				   				 <div class="col-sm-3 text-left"><input class="form-control" ng-model="ctrl.productData.taxPerc" id="dlgVat" disabled="disabled"/></div>
		...
		<div id="grid1" ui-grid="gridOptions" ui-grid-save-state ui-grid-selection ui-grid-edit ui-grid-cellnav class="grid">
		...
		<div class="row lineHeight">
   	  	...
   	  	<div class="row lineHeight">
           	 <div class="col-sm-2 text-right"><button name="save" id="save" ng-click="ctrl.save()" class="btn btn-default">Save</button></div>
   			 <div class="col-sm-2 text-center"><button name="submit" id="submit" ng-click="ctrl.submit()" class="btn btn-default">Submit</button></div>
   			 <div class="col-sm-2"><button name="modifySales" id="modifySales" ng-click="ctrl.fetchSales()" class="btn btn-default">Modify</button></div>
   			 <div class="col-sm-2"><button name="printBill" id="printBill" ng-click="ctrl.printBill()" class="btn btn-default">Print</button></div>
   			 <div class="col-sm-2"><button name="deleteSales" id="deleteSales" ng-click="ctrl.deleteSales()" class="btn btn-default">Delete</button></div>
   			 <div class="col-sm-2"><button name="resetSales" id="resetSales" ng-click="ctrl.resetSales()" class="btn btn-default">Reset</button></div>
        </div>
