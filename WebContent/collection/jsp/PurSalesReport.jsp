<div class="purSalesReportForm" ng-controller="reportController as ctrl">
	<div class="row lineHeight">
   	...
   	<div class="row lineHeight">
		 <div class="form-group">
  			<div class="col-sm-4 text-right"><button name="fetch" id="fetch" ng-click="ctrl.fetchPurSalesReport()" class="btn btn-default">Fetch Report</button></div>
  			<div class="col-sm-4 text-right"><button name="download" id="download" ng-click="ctrl.downPurSalesReport()" class="btn btn-default">Download</button></div>
		 </div>
  	</div>
  	<br>
  	<div id="grid3" ui-grid="gridOptions2" ui-grid-save-state ui-grid-selection ui-grid-edit ui-grid-cellnav class="gridBig">
